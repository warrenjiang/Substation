  ...
  app_tcp_init();//³õÊ¼»¯tcp
    ...
    if(sysCfg.parameter.data_socket == SOCK_BUS)//ÅäÖÃÁËµÚÈý·½·þÎñÆ÷
		...
		{ 
			...
			/*Óë·þÎñÆ÷±£³ÖÍ¨Ñ¶³¬Ê± ³¬¹ý HEART_OUTTIME_TIMES Ê±¼äÎ´½ÓÊÕµ½·þÎñÆ÷Í¨ÐÅÐÅÏ¢ Ö¸Ê¾ºìµÆ*/
        ...
        udp_senddata(udppcb);//·¢ËÍudp°ü				
			...
			/*Ö÷·þÎñÆ÷ PING ³¬³öMQTT_RECONNECT_TIMEÃëÎÞÏìÓ¦ ÖØÁ¬*/
			...
			/*µÚÈý·½·þÎñÆ÷ PING ³¬³öMQTT_RECONNECT_TIMEÃëÎÞÏìÓ¦ ÖØÁ¬*/
